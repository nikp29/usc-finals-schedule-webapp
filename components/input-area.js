      ...
      <form className="m-0 flex-1 flex flex-col items-start justify-start gap-[52px] max-w-full mq675:gap-[52px]">
        ...
        <div className="w-[681px] flex flex-col items-start justify-start pt-0 px-0 pb-[9px] box-border gap-[16px] max-w-full">
          ...
          <div className="self-stretch flex flex-row items-start justify-between gap-[20px] max-w-full mq675:flex-wrap">
            <div className="w-[451px] bg-gainsboro box-border flex flex-row items-center justify-start pt-[7px] px-2.5 pb-[5px] max-w-full border-[1px] border-solid border-gray-300">
            ...
            <button className="cursor-pointer py-1.5 pr-[30px] pl-[27px] bg-darkred w-[133px] box-border flex flex-row items-center justify-center border-[1px] border-solid border-gray-300 hover:bg-firebrick hover:box-border hover:border-[1px] hover:border-solid hover:border-darkslategray">
